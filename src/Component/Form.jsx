...
const Form = () => {
  ...
  const questionData = [
    {
      id: 1,
      question: "Çalışdığınız müəssisənin adını qeyd edin.*;",
    },
    {
      id: 2,
      question: "Vəzifənizi qeyd edin.*",
    },
  ];
  ...
  return (
    <div className="bg-white p-10 pb-1">
      <h2 className="text-emerald-900 text-xl w-fit ml-2">İş təcrübəsi</h2>
      <LineProgresBar />
      ...
      <div className="flex justify-start gap-5">
        <button
          ...
          className={`px-4 py-2 border border-gray-200  rounded-3xl w-36 flex items-center justify-end gap-10 text-base`}
        >
          Bəli
          <input
            type="radio"
        ...
        <button
          ...
          className={`px-4 py-2 border border-gray-200 rounded-3xl w-36 flex items-center justify-end gap-8 text-base`}
        >
          Xeyr
          <input
            type="radio"
      ...
      <div>
        {questionData?.map((item) => (
          <div key={item.id}>
            <h3 className="text-lg ml-2">{item.question}</h3>
            <input
              required
              type="text"
              className="w-[490px] border  bg-gray-200 focus:outline-none px-3 rounded-lg"
            />
          </div>
        ))}
      </div>
      ...
      <div className="flex justify-between">
        <div className="w-60">
          <h3 className="ml-2 ">Əmək fəaliyyət forması:</h3>
        ...
        <div className="w-60">
          <h3 className="ml-2 ">Peşəkarlıq dərəcəsi:</h3>
          <div className="relative">
      ...
      <div>
        <div className="flex justify-between">
          <div>
            <h2 className="ml-2">İşə başlama tarixi:</h2>
            <Calendar />
          </div>
          <div>
            <h2 className="ml-2 ">İşdən ayrılma tarixi:</h2>
            <Calendar />
          </div>
        </div>
      ...
      <div className="flex justify-center">
        <button className={`px-4 py-2 border border-gray-200 rounded-3xl w-[155px] flex items-center justify-center gap-2  text-base`}>
          Yadda saxla
